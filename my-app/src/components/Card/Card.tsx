...
const Card: React.FC<cardInfoProps> = ({ component_name, category, price, image_path }) => {
  return (
    <div className={styles.card}>
      <div className={styles.card__image}>
        {image_path ? (
          <img className={styles.card__image_img} src={image_path} alt="aaa"></img>
        ) : (
          <img
      ...
      <div className={styles.card__inner}>
        <div className={styles.card__inner_title}>{component_name}</div>
